...
public class Estoque extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtQntd, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(18, 18, 18)
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
       DefaultTableModel tbProduto = (DefaultTableModel) tbEstoque.getModel();
        Object [] dados = {txtCodigo.getText(), txtItem.getText(), txtQntd.getText()};
        tbProduto.addRow(dados);
    }//GEN-LAST:event_btInserirActionPerformed

    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
if(tbEstoque.getSelectedRow() != -1){
            tbEstoque.setValueAt(txtCodigo.getText(), tbEstoque.getSelectedRow(), 0);
            tbEstoque.setValueAt(txtItem.getText(), tbEstoque.getSelectedRow(), 1);
            tbEstoque.setValueAt(txtQntd.getText(), tbEstoque.getSelectedRow(), 2);
         }       
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
         if (tbEstoque.getSelectedRow() != -1){
        DefaultTableModel tbProduto = (DefaultTableModel) tbEstoque.getModel();
        tbProduto.removeRow(tbEstoque.getSelectedRow());
        }
